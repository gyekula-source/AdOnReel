      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
        ...
        <SlideUp delay={0.2}>
          <GlassCard className="p-10 h-full relative overflow-hidden border-purple/30">
            <div className="absolute top-0 right-0 bg-purple text-primary text-xs font-bold px-4 py-1 rounded-bl-xl">POPULAR</div>
            ...
            <div className="text-5xl font-black text-foreground mb-2">15% <span className="text-lg text-muted font-normal">fee</span></div>
