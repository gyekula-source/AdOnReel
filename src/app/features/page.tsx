    ...
    <div className="min-h-screen pt-32 pb-20 px-4 md:px-8 bg-[#FDD7E4] relative overflow-hidden">
      <div className="max-w-7xl mx-auto relative z-10 text-center mb-20">
        <SlideUp>
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 text-foreground">Everything you need to <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple to-blue">scale</span></h1>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 relative z-10 mb-20">
      ...
      <div className="max-w-7xl mx-auto relative z-10 mt-20 pt-20 border-t-2 border-purple/20">
        <SlideUp>
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl md:text-6xl font-bold mb-6 text-foreground">Meet Our Founders</h2>
            <p className="text-xl text-foreground/70 max-w-2xl mx-auto">
              Visionary leaders driving innovation in creator monetization.
            </p>
          </div>
        </SlideUp>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <SlideUp delay={0.2}>
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-foreground mb-2">Talapureddi. Sasi Kiran</h3>
              <p className="text-lg font-semibold text-purple mb-2">Director</p>
              <p className="text-foreground/70">Driving operational excellence and strategic growth initiatives.</p>
            </div>
          </SlideUp>
