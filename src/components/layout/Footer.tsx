...
export function Footer() {
  ...
  return (
    <footer className="bg-dark pt-24 pb-12 border-t border-white/5 relative overflow-hidden">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-purple/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12 mb-16">
          <div className="col-span-2 lg:col-span-2">
            ...
            <p className="text-muted max-w-sm mb-6">
              The premier AI-powered influencer advertising marketplace. Turn every reel into revenue with automated campaigns.
            </p>
          </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-muted text-sm">
            &copy; {currentYear} AdOnReel Inc. All rights reserved.
          </p>
